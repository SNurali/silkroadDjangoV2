...
class Command(BaseCommand):
    help = 'Populates the database with official countries'
    ...
    def handle(self, *args, **options):
        countries = [
            ...
            ("CN", "China"), ("CO", "Colombia"), ("KM", "Comoros"), ("CG", "Congo (Congo-Brazzaville)"), ("CD", "Congo (DRC)"),
        ...
        # Prioritize Uzbekistan
        
        count = 0
        for code, name in countries:
            obj, created = Country.objects.get_or_create(
                name=name,
                defaults={'iso_code': code}
            )
            if created:
                count += 1
            else:
        ...
        self.stdout.write(self.style.SUCCESS(f'Successfully populated {count} new countries'))
